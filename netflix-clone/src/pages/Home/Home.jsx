      ...
      <div className="hero">
        ...
        <div className="hero-caption">
            ...
            <p>Discovering his ties to a secret ancient order, a young man 
                living in modern Instanbul embarks on a quest to save the city from an immortal enemy</p>
            <div className="hero-btns">
                <button className='btn'><img src={play_icon}/>Play</button>
                <button className='btn darkbtn'><img src={info_icon}/>More Info</button>
            </div>
            <TitleCards/>
        </div>
      </div>
